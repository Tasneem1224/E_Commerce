...
import Image0 from "/images/Group 1.png";
      ...
      <div className="signup-form">
        {submitted ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p className="p2" onClick={handleLoginRedirect}>
            ...
            <button className="signupbu" type="submit">Create an Account</button>
            <br />
            <br />
            <p className="p4" onClick={handleLoginRedirect}>
              Already have an account? <u>Log in</u>
            </p>
          </form>
        )}
